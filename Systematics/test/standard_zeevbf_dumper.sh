...
echo " #######################################"
fggRunJobs.py --load DYDump.json -d /vols/cms04/yhaddad/validation-${today}-76x_${label}_rms_2.00 \
	      -x cmsRun VBFTagDumper_JetVeto_cfg.py maxEvents=-1 \
	      -q hepshort.q --no-use-tarball useAAA=1 targetLumi=1.00e+3 \
