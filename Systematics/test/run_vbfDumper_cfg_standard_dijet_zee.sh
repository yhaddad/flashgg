...
# data/RunIISpring15-AllSilverIncludingGold-1_1_0-25ns.json \
# data/RunIISpring15-AllSilverIncludingGold-1_1_0-25ns_noDY.json \
#fggRunJobs.py --load big_test_jobs_25ns.json -d /vols/cms04/yhaddad/output_Zee_validation \
fggRunJobs.py --load small_zee_jobs_25ns.json -d /vols/cms04/yhaddad/output_Zee_validation \
    -x cmsRun VBFTagDumper_standard_zee_cfg.py maxEvents=-1 \
