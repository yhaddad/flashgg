...
fggRunJobs.py --load small_zee_single_ele_jobs_25ns.json -d /vols/cms04/yhaddad/output_zee_validation_single_elec \
    -x cmsRun VBFTagDumper_standard_zee_single_elec_cfg.py maxEvents=-1 \
