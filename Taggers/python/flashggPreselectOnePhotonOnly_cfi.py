...
#this version used for promt-fake parametrisation studies
flashggPreselectOnePhotonOnly = cms.EDFilter(
    ...
    cut = cms.string(
        ...
        " && leadingPhoton.hadronicOverEm < 0.08"
        " && leadPhotonId > -0.9"
        " && leadingPhoton.genMatchType == 1  )"
        " || "
        ...
        " && subLeadingPhoton.hadronicOverEm < 0.08"
        " && subLeadPhotonId > -0.9"
        " && subLeadingPhoton.genMatchType == 1  )  )"
        " && leadingPhoton.pt > 30.0"
        " && abs(leadingPhoton.superCluster.eta) < 2.5"
        " && (abs(leadingPhoton.superCluster.eta) < 1.4442 || abs(leadingPhoton.superCluster.eta) > 1.566)"
        " && subLeadingPhoton.pt > 20.0"
