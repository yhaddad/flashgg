...
json=/home/hep/jw3914/Work/VBF_Zee/CMSSW_8_0_20/src/flashgg/Taggers/test/VBF-MORIOND-2017/run_mc_files.json 

# "none" "tight" "medium" "loose" "forward_tight" "forward_medium" "forward_loose"
for wp in "none"
do 
    today=`date +%F`
    outdir=/vols/cms/jwright/vbf-trees-RunII16Fall-80x/pujid-study2-${wp}-${today}
