...
jsonfile=/home/hep/jw3914/Work/VBF_Zee/CMSSW_8_0_20/src/flashgg/Taggers/test/VBF-MORIOND-2017/run_dy_test.json


for wp in "none" # "tight" "medium" "loose"
do 
    today=`date +%F`
    outdir=/vols/cms/yhaddad/VBF-test/test-${wp}-${today}
