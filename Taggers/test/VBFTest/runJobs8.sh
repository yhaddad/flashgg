...
if [[ $retval == 0 ]]; then
    touch runJobs8.sh.done
    cp -pv runJobs8.sh.done /home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest
else
    touch runJobs8.sh.fail
    cp -pv runJobs8.sh.fail /home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest
fi
