...
ls $X509_USER_PROXY
cmsRun /home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest/vbfDumper_cfg.py maxEvents= useAAA=1 campaign=RunIISpring15-50ns processIdMap=/home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest/config.json dataset=GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCUETP8M1_13TeV_Pythia8 outputFile=/home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest/output_GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCUETP8M1_13TeV_Pythia8.root lastAttempt=1
retval=$?
if [[ $retval == 0 ]]; then
    errors=""
...
if [[ $retval == 0 ]]; then
    touch runJobs7.sh.done
    cp -pv runJobs7.sh.done /home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest
else
    touch runJobs7.sh.fail
    cp -pv runJobs7.sh.fail /home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest
fi
