...
if [[ $retval == 0 ]]; then
    touch runJobs6.sh.done
    cp -pv runJobs6.sh.done /home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest
else
    touch runJobs6.sh.fail
    cp -pv runJobs6.sh.fail /home/hep/yhaddad/CMSSW_7_4_12/src/flashgg/Taggers/test/VBFTest
fi
