...
json=/home/hep/yhaddad/work/temp/CMSSW_8_0_25/src/flashgg/Taggers/test/mc_jan_25/run_mc_moriod17_2_4_1.json

# 
for wp in "tight" #"none" "tight" "medium" "loose"
do 
    today=`date +%F`
    outdir=/vols/cms/yhaddad/VBF-Tree-Moriond17/sklean-MVA-v5-${wp}-${today}
