...
new_variables = [
    #"parton1_pt            := tagTruth().leadingParton().pt()",
    #"parton2_pt            := tagTruth().subLeadingParton().pt()",
    #"parton3_pt            := tagTruth().subSubLeadingParton().pt()",
    ...
    #"jet3_btag := subSubLeadingJet_ptr.bDiscriminator(\"pfCombinedInclusiveSecondaryVertexV2BJetTags\")"
    ]
all_variables = var.dijet_variables + var.dipho_variables + var.truth_variables + new_variables
