...
for wp in "tight" "medium" "loose" "forward_tight" "forward_medium" "forward_loose"
do 
    today=`date +%F`
    outdir=/vols/cms/yhaddad/vbf-trees-RunII16Fall-80x/pujid-zee-${wp}-${today}
    fggRunJobs.py --load control.json -d ${outdir} \
		  -x cmsRun standard_vbf_dumper_cfg.py maxEvents=-1 runOnZee=True \
		  -q hepmedium.q --no-use-tarball useAAA=0 atIC=1 targetLumi=1.00e+3 pujidWP=$wp \
		  lumiMask=/home/hep/yhaddad/work/area01/CMSSW_8_0_8_patch1/src/flashgg/MetaData/work/jsons/Cert_271036-275783_13TeV_PromptReco_Collisions16_JSON.txt \
		  -n 100   puTarget=2.31e+03,3.09e+04,1.99e+05,5.39e+05,8.22e+05,1.09e+06,2e+06,1.12e+07,2.8e+07,4.49e+07,7.29e+07,1.13e+08,1.72e+08,2.53e+08,3.33e+08,3.9e+08,4.18e+08,4.2e+08,3.96e+08,3.52e+08,2.96e+08,2.35e+08,1.76e+08,1.23e+08,7.86e+07,4.6e+07,2.45e+07,1.18e+07,5.18e+06,2.09e+06,7.91e+05,2.86e+05,1.03e+05,3.95e+04,1.84e+04,1.12e+04,8.66e+03,7.55e+03,6.94e+03,6.56e+03,6.29e+03,6.1e+03,5.94e+03,5.79e+03,5.64e+03,5.47e+03,5.27e+03,5.04e+03,4.79e+03,4.51e+03
done 


#/home/hep/yhaddad/work/area01/CMSSW_8_0_8_patch1/src/flashgg/MetaData/work/jsons/Cert_271036-275783_13TeV_PromptReco_Collisions16_JSON.txt
