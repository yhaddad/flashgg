...
namespace flashgg {
    ...
    class VbfTagTestAnalyzer : public edm::EDAnalyzer
    {
    public:
        explicit VbfTagTestAnalyzer( const edm::ParameterSet & );
        ~VbfTagTestAnalyzer();
...
//
    VbfTagTestAnalyzer::VbfTagTestAnalyzer( const edm::ParameterSet &iConfig ):
    ...
    VbfTagTestAnalyzer::~VbfTagTestAnalyzer()
    {

    }

    void
    VbfTagTestAnalyzer::analyze( const edm::Event &iEvent, const edm::EventSetup &iSetup )
    {
    ...
    void
    VbfTagTestAnalyzer::fillDescriptions( edm::ConfigurationDescriptions &descriptions )
    {
...
typedef flashgg::VbfTagTestAnalyzer FlashggVbfTagTestAnalyzer;
DEFINE_FWK_MODULE( FlashggVbfTagTestAnalyzer );
// Local Variables:
// mode:c++
